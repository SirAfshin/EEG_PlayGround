...
if __name__ == "__main__":
    rng_num = 122
    batch_size = 256
    dataset_name= 'Dreamer_DE_Grid_no'
    ...
    model = VisionTransformerEEG(img_size= dataset[0][0].shape[1], # data[5,9,9]
                                patch_size=3,
    ...
    model_name = "Dreamer_DE_Grid_" + model.__class__.__name__ + "" # _Time_To2d_b
