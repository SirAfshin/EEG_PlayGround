...
if __name__ == "__main__":
    ...
    dataset_name = 'Dreamer_STFT_Spectrogram_02'
    ...
    dataset = DREAMERDataset(io_path=f"{io_path}",
                            ...
                            offline_transform=transforms.Compose([
                                STFTSpectrogram(n_fft=128, hop_length=2, contourf=False), # [batch,14, 65, 65]
    ...
    model_name = model.__class__.__name__ + "_65x65" 
